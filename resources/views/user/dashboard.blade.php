    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header d-flex align-items-center">
        <a class="navbar-brand" href="dashboard.html">
          <img src="../../assets/dashboard/img/brand/blue.png" class="navbar-brand-img" alt="...">
        </a>
        <div class="ml-auto">
          <!-- Sidenav toggler -->
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="alternative.html#navbar-dashboards" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-dashboards">
              ...
              <div class="collapse show" id="navbar-dashboards">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="alternative.html" class="nav-link active">Alternative</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="alternative.html#navbar-examples" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-examples">
            ...
            <li class="nav-item">
              <a class="nav-link" href="alternative.html#navbar-components" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-components">
              ...
              <div class="collapse" id="navbar-components">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <a href="alternative.html#navbar-multilevel" class="nav-link" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-multilevel">Multi level</a>
                    <div class="collapse show" id="navbar-multilevel" style="">
                      <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                          <a href="alternative.html#!" class="nav-link ">Third level menu</a>
                        </li>
                        <li class="nav-item">
                          <a href="alternative.html#!" class="nav-link ">Just another link</a>
                        </li>
                        <li class="nav-item">
                          <a href="alternative.html#!" class="nav-link ">One last link</a>
                        </li>
                      </ul>
                    </div>
                  </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="alternative.html#navbar-forms" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-forms">
            ...
            <li class="nav-item">
              <a class="nav-link" href="alternative.html#navbar-tables" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-tables">
            ...
            <li class="nav-item">
              <a class="nav-link" href="alternative.html#navbar-maps" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-maps">
